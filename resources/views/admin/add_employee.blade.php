                ...
                <form method="POST" action="{{ route('admin.employees.store') }}">
                    ...
                    <div class="border-t py-4 flex items-center">
                        ...
                        <div class="sm:w-2/5 w-full text-sm">
                            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="山田 太郎" class="border-gray-300 rounded w-full">
                        </div>
                    </div>
                    <div class="border-t py-4 flex items-center">
                        <div class="w-36"><label for="email" class="font-bold">メールアドレス</label></div>
                        <div class="sm:w-2/5 w-full text-sm">
                            <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="test@test.com" class="border-gray-300 rounded w-full">
                        </div>
                    </div>
